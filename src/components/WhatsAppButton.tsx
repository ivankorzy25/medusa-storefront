...
export function WhatsAppButton() {
  ...
  const whatsappUrl = `https://wa.me/${BRAND.whatsapp}?text=${encodeURIComponent(
    "Hola! Me interesa consultar sobre generadores eléctricos"
  )}`;
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        {/* Main button */}
        <div className="relative bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 w-16 h-16 rounded-full shadow-2xl flex items-center justify-center transform transition-all duration-300 hover:scale-110">
          {/* WhatsApp Icon */}
          <svg
      ...
      <div className="absolute -top-12 left-1/2 -translate-x-1/2 bg-white text-gray-900 px-3 py-1 rounded-full text-xs font-bold shadow-lg opacity-0 group-hover:opacity-100 transition-opacity md:hidden whitespace-nowrap">
        {BRAND.phoneDisplay}
      </div>
    </a>
  );
